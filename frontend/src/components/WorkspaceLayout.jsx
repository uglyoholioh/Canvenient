...
const getInitialView = () => {
  ...
  return [
    ...
    "groups",
    "wheel",
  ].includes(stored) || /^note-\d+$/.test(stored)
    ? stored
    : "dashboard";
};
            ...
            <header className="mac-workspace-toolbar" data-tauri-drag-region>
              ...
              >
                ...
                <button
                  ...
                  onClick={() =>
                    setAndPersistSidebarBehavior(sidebarBehavior === "hidden" ? "hover" : "hidden")
                  }
              ...
              {!toolbar?.hideSearch && (
                <button
                  type="button"
                  className="mac-toolbar-search mac-toolbar-search-primary"
              ...
              <div className="mac-sidebar-rail" style={{ width: layoutSidebarWidth }}>
                <aside
                  ...
                  style={{
                    ...
                    borderInlineEnd: isSidebarVisible ? undefined : 0,
                  }}
                >
                  <header
                    className="mac-sidebar-header"
                    style={{
                      paddingInline: isSlim ? 0 : "12px",
                      justifyContent: isSlim ? "center" : "flex-start",
                    }}
                  >
                    <div className="mac-sidebar-brand" aria-hidden={isSlim}>
                      <span className="mac-sidebar-brand-mark" aria-hidden="true">
                        C
                      </span>
                  ...
                  <div className={`mac-sidebar-scroll ${isSlim ? "is-slim" : ""}`}>
                    ...
                    <nav className="mac-source-list" aria-label="Workspace views">
                      ...
                      <NavItem
                        ...
                        icon={FileText}
                        label="Notes"
                        active={activeTab === "notes" || activeTab.startsWith("note-")}
                          ...
                          onClick={() =>
                            window.dispatchEvent(
                              new CustomEvent("canvenient-toast", {
                                detail: { message: "Folder creation coming soon!" },
                              }),
                            )
                          }
                        ...
                        onClick={() =>
                          window.dispatchEvent(
                            new CustomEvent("canvenient-toast", {
                              detail: {
                                message:
                                  "Click the + button to create a folder. Feature coming soon!",
                              },
                            }),
                          )
                        }
              ...
              <main className="mac-workspace-main">
                <div className="mac-workspace-content">
                  <Suspense fallback={<ViewLoader />}>
                    ...
                    {activeTab === "wheel" && (
                      <SpinWheelView token={token} onNavigate={setActiveTab} />
                    )}
              ...
              >
                ...
                >
                  ...
                  <dl>
                    <div>
                      <dt>Search</dt>
                      <dd>{formatShortcut(shortcuts.search)}</dd>
                    </div>
                    <div>
                      <dt>Tasks panel</dt>
                      <dd>{formatShortcut(shortcuts.tasksPanel)}</dd>
                    </div>
                    <div>
                      <dt>Assistant</dt>
                      <dd>{formatShortcut(shortcuts.assistant)}</dd>
                    </div>
                    <div>
                      <dt>New task</dt>
                      <dd>{formatShortcut(shortcuts.quickTask)}</dd>
                    </div>
                    <div>
                      <dt>Quick note</dt>
                      <dd>{formatShortcut(shortcuts.quickNote)}</dd>
                    </div>
                    <div>
                      <dt>Import timetable</dt>
                      <dd>⌘O</dd>
                    </div>
                    <div>
                      <dt>Switch views</dt>
