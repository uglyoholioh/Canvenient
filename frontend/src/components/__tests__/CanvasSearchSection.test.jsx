...
describe("CanvasSearchSection", () => {
  ...
  const mockFilesByCourse = {
    101: [
      {
        id: "f1",
        display_name: "ST2334_Lecture_Week_5.pdf",
        size: 1048576,
        updated_at: "2026-09-01T10:00:00Z",
        url: "https://canvas.nus.edu.sg/files/f1",
      },
      {
        id: "f2",
        display_name: "ST2334_Tutorial_4_Solutions.pdf",
        size: 524288,
        updated_at: "2026-08-25T10:00:00Z",
        url: "https://canvas.nus.edu.sg/files/f2",
      },
      {
        id: "f3",
        display_name: "ST2334_Lecture_Week_6.pdf",
        size: 2048576,
        updated_at: "2026-09-08T10:00:00Z",
        url: "https://canvas.nus.edu.sg/files/f3",
      },
    ],
    102: [
      {
        id: "f4",
        display_name: "CS2040S_Lecture_Week_5_Graphs.pdf",
        size: 1548576,
        updated_at: "2026-09-01T10:00:00Z",
        url: "https://canvas.nus.edu.sg/files/f4",
      },
    ],
  };
