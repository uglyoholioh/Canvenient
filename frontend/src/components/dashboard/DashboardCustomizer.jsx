  ...
  return (
    <div className={`dashboard-customizer ${compact ? "is-compact" : ""}`}>
      <div className="dashboard-layout-options">
        ...
        <button
          type="button"
          className={layout === "bento" ? "is-active" : ""}
        ...
        <button
          type="button"
          className={layout === "custom" ? "is-active" : ""}
      ...
      <p className="dashboard-customizer-hint">
        Choose Edit to move cards or resize them from any edge. Shared edges adjust neighboring
        cards live.
      </p>
          ...
          return (
            <div className="dashboard-module-setting" key={moduleId}>
              <button
                ...
                onClick={() => updateVisibility(moduleId)}
                aria-label={`${visible ? "Hide" : "Show"} ${module.label}`}
              >
