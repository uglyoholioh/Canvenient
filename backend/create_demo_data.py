    ...
    tasks = [
        {
            ...
            "status": "todo",
            "priority": "high",
            "cat_id": cat_ids["Urgent"],
            "due_at": now + timedelta(days=1),
        },
        {
            "title": "Revise MA1521 Chapter 4",
            "status": "todo",
            "priority": "medium",
            "cat_id": cat_ids["Study"],
            "due_at": now + timedelta(days=2),
        },
        {"title": "Buy groceries", "status": "todo", "priority": "low", "cat_id": cat_ids["Personal"], "due_at": None},
        {
            "title": "Submit final report draft",
            "status": "done",
            "priority": "high",
            "cat_id": cat_ids["Urgent"],
            "due_at": now - timedelta(days=1),
    ...
    announcements = [
        {
            ...
            "course_id": 1,
            "course_code": "CS2040S",
            "title": "Welcome to CS2040S!",
            "message": "Here is the syllabus and schedule.",
        ...
        },
        {
            ...
            "course_id": 1,
            "course_code": "MA1521",
            "title": "Room change for tomorrow's lecture",
            "message": "We will be in LT27 instead of LT19.",
